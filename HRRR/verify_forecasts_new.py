...
fcst_file = 'predictions_nn_40km_2hr_hrrrv4-epoch30-model4'
...
predictions_all_nn = df['predictions%d'%i].values
...
predictions_gridded_uh, labels_gridded = make_gridded_forecast((uh120_all>75).astype(np.int32), labels_all[:,i], dates_all, fhr_all)
